...
CANONICAL_PHASES: List[PhaseConfig] = [
    ...
    PhaseConfig(
        ...
        description="Payload-based: SQLi, XSS, SSRF (metadata), IDOR iteration, CORS origin spoofing, JWT none-alg",
        cli_command="swarm-scan",
        cli_extra_args=["--agents", "sqli", "xss", "ssrf", "idor", "auth", "api", "--yes"],
