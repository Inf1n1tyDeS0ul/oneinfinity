...
def get_status():
    ...
    try:
        from oneinfinity.infra.auto_architecture_engine import cmd_arch_status
...
def emit_event(req: EmitEventRequest, background_tasks: BackgroundTasks):
    ...
    engine = _get_engine()
    try:
        from oneinfinity.infra.auto_architecture_engine import ArchEvent, EventType
        ev = ArchEvent(
...
def list_event_types():
    try:
        from oneinfinity.infra.auto_architecture_engine import EventType
