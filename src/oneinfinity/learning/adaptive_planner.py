...
from oneinfinity.learning.neo4j_knowledge_base import Neo4jKnowledgeBase as KnowledgeBase
from oneinfinity.learning.pattern_miner import PatternMiner, TargetInsight
