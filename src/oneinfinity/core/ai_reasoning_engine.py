...
class AIReasoningEngine:
    ...
    def _get_cache(self):
        if self._cache is None:
            try:
                from oneinfinity.core.llm_cache import get_llm_cache
    ...
    def _get_validator(self):
        if self._validator is None:
            try:
                from oneinfinity.core.llm_validator import get_llm_validator
    ...
    def generate_attack_plan(
        ...
        try:
            ...
            if ctx is not None:
                from oneinfinity.core.context_builder import build_llm_context, context_fingerprint, format_for_prompt
