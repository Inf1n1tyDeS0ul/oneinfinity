...
class MobileSecurityEngine:
    ...
    def _lazy_load(self):
        ...
        _try("_frida_gen",        "oneinfinity.mobile.frida_script_generator",   "frida_script_generator")
        ...
        _try("_component_tester", "oneinfinity.mobile.android_component_testing","android_component_tester")
        ...
        _try("_android_studio",   "oneinfinity.mobile.android_studio_integration","android_studio_integration")
