...
class AISecurityEngine:
    ...
    def _load_wrappers(self) -> None:
        from oneinfinity.ai_security.tool_wrappers.garak_wrapper import GarakWrapper
        from oneinfinity.ai_security.tool_wrappers.pyrit_wrapper import PyRITWrapper
        from oneinfinity.ai_security.tool_wrappers.giskard_wrapper import GiskardWrapper
        from oneinfinity.ai_security.tool_wrappers.purple_llama_wrapper import PurpleLlamaWrapper
        from oneinfinity.ai_security.tool_wrappers.rebuff_wrapper import RebuffWrapper
        from oneinfinity.ai_security.tool_wrappers.art_wrapper import ARTWrapper
