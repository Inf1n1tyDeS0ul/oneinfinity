...
CAPABILITIES: dict[str, ToolCapability] = {
    ...
    "subfinder": ToolCapability(
        ...
        detects=[Vuln.SUBDOMAIN_TAKE],   # indirectly — feeds dnsx for takeover check
        inputs=[
        ...
        confidence={Vuln.SUBDOMAIN_TAKE: "low"},   # needs dnsx to confirm
    ...
    "commix": ToolCapability(
        ...
        requires_phase=["http", "crawl"],
        feeds_into=["report"],
        confidence={Vuln.CMD_INJECTION: "high"},
        typical_duration_sec=180,
        rate_sensitive=True,
        noise_level="high",
    ...
    "gf": ToolCapability(
        ...
        detects=[],    # classifier, not scanner
        inputs=[
