...
def test_ingest_delegates_to_db_manager_save_finding():
    ...
    with patch("oneinfinity.findings.result_ingestion_engine._require_pg", return_value=mock_mgr):
        from oneinfinity.findings.result_ingestion_engine import ResultIngestionEngine, RawResult
...
def test_ingest_raises_when_pg_unavailable():
    ...
    with patch("oneinfinity.findings.result_ingestion_engine._require_pg",
