...
| Multi-format report export (JSON, CSV, Markdown) | HIGH |
...
- **DOM XSS validation**: No headless browser in the validation engine; DOM XSS detection is pattern-based only.
